  ...
  render: function () {
    ...
    return (
      <div style={style} className='blue col-6'>
        ...
        <p>My name is Alejandro Oviedo, I&#39;m a front-end developer and I love building beautiful UXs.  Learning and experimenting with new ways to do awesome things on computer screens gets me excited.
          Currently, I&#39;m a contractor helping CVS/pharmacies build their next generation web applications.</p>
